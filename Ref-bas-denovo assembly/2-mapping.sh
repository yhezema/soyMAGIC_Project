...
# ===============================
#!/bin/bash
#SBATCH --job-name=map_RG11 # Change the name to the desired parents each time
...
echo "[Step 2.2] $parent sorting and removing intermediate files completed successfully at [$(date)]" >> "$LOG"
